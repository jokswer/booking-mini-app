    ...
    games: [
      {
        ...
        current_gamers: 1,
        describtion:
          "Великий пожиратель хочет кушать, скидываемся на поёк\n asd asd asd as \n das d a",
      },
      {
        id: "1333",
        type: "kt",
        ...
        current_gamers: 1,
        describtion:
          "Пу-пу-пу, у меня только терраниды, больше ни кем не играю",
      },
    ],
  },
  {
    ...
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRh68xHpPnRUqYPpHd2qR45McvM2zOi-f3MPg&s",
    date: "13.02.2026",
    games: [
      {
        id: "121212",
